...
void main() {
  group('AppNavigationRailWidget', () {
    Widget host({ValueChanged<AppTab>? onSelect, VoidCallback? onAccount, String accountLabel = 'User7421'}) => Scaffold(
      body: Row(
        children: [
    ...
    testWidgets('renders both destinations, and carries no create button', (tester) async {
      // The `+` used to lead this rail. It is the Chats pane header's now: with
      // two destinations under it, a 56dp FAB was the heaviest thing on the
      // window, for an action that belongs beside the list it creates into.
      ...
      expect(find.byTooltip(l10nEn.tooltipCreateChat), findsNothing);
    });
