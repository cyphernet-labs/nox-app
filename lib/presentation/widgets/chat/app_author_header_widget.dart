...
/// current display name. Own messages have no header. `labelMedium` on `primary`.
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Align(
        ...
        child: Text(label, style: textTheme.labelMedium?.copyWith(color: colorScheme.primary)),
      ),
    );
  }
}
