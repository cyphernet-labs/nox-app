...
/// Whether the "pick a QR image" pairing fallback is offered on Login (2.1). Shown only
...
/// two camera-less desktops a QR pairing at parity with the scan platforms (feature P14).
///
...
abstract final class QrImagePairingCapability {
  const QrImagePairingCapability._();
