...
<!-- SPECKIT START -->
Active feature: **002-design-system-assets** — ingest all prepared design-system resources from `docs/design/system/` into `lib/design` + `assets/` (37 Material Symbols SVG icons, brand logo, 3 empty-state illustrations, `Roboto`/`Roboto Mono` fonts, all 9 token sets), without implementing any UI Kit / widgets / screens. Plan: `specs/002-design-system-assets/plan.md` (Technical Context, Project Structure, Constitution Check vs v1.1.0). Phase 0/1 artifacts: `research.md`, `data-model.md`, `contracts/design-system-api.md`, `quickstart.md`. Spec: `specs/002-design-system-assets/spec.md` (clarified 2026-06-15: bundle fonts 400/500/700+mono400; bundle 37 SVGs; verify-sync tokens, no JSON→Dart pipeline; remove `AppImagesTokens`).
<!-- SPECKIT END -->
