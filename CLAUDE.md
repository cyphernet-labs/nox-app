...
- **`docs/patterns/mobile/`** — the **adopted NOX Flutter Clean Architecture blueprint** (`00`–`17`, index in `README.md`). **Consult it at the start of any Flutter/client task (all five platforms) and build to it** — see its section below.
...
<!-- SPECKIT START -->
Active feature: **001-flutter-project-init** — initialize the NOX Flutter multi-platform skeleton (iOS/Android/Windows/Linux/macOS; no web). Plan: `specs/001-flutter-project-init/plan.md` (technical context, project structure, Constitution Check against v1.1.0). Phase 0/1 design artifacts: `research.md`, `data-model.md`, `contracts/`, `quickstart.md`. Spec: `specs/001-flutter-project-init/spec.md`.
<!-- SPECKIT END -->
