...
| **База данных** | **SQLite** через `modernc.org/sqlite` (чистый Go, без CGO) | Масштаб «один человек и его устройства»; ноль администрирования; бэкап — один файл; путь PocketBase |
