...
Критерии выбора: деплой на все десктопные платформы и ARM; размер дистрибутива; простота установки для нетехнического пользователя; лёгкая и стабильная БД; восстановимость. Владение языком внутри команды из критериев исключено. Сравнение кандидатов (Python / Rust / Go / Dart / Elixir) — §2.
