...
flowchart LR
  ...
  APP -->|"HTTPS, файлы"| CB
  CB -.->|"протокол не выбран"| RELAY["Relay-сервер"]
...
Дальше — постоянный WebSocket, **17 команд и 6 событий** (полный инвентарь в `docs/client-backend/protocol/wire-surface.md`). Конверт пока не зафиксирован.
