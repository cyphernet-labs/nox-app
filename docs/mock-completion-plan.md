...
| N4 | (опц.) Вход в `Settings/Account` с мобилки — **проверено: уже достижимо** (bottom-bar `Settings`-таб = мобильный вход в Account, роль rail'а; доп. аватар-аффорданс избыточен + churn голденов) (§3c) | 🔵 | S | точечно | ⏸ |
