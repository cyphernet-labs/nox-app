...
- **Body:**
  ...
  - **Единственный `SwitchListTile`** `Enable notifications` (on / off), с ведущим чипом 40dp (`secondaryContainer`, колокольчик `onSecondaryContainer`) — как во всех строках настроек. ⚠️ Чип ненадолго убирали на том основании, что это была единственная иконка на строке настроек; владелец 2026-09-20 отменил правило «строки без иконок», и теперь без чипа эта строка была бы белой вороной.
