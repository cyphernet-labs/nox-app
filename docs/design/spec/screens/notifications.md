...
- **Body:**
  - При permission-denied (системный отказ ОС) — `MaterialBanner` наверху с пояснением и кнопкой `Open settings`. Кнопка — на **своей строке под текстом, у правого края**, как M3 и раскладывает действия баннера (`MaterialBanner` во Flutter кладёт их в `OverflowBar`, заканчивающийся справа). Слева она стояла посреди баннера и читалась как ссылка, оброненная в текст.
  - **Единственный `SwitchListTile`** `Enable notifications` (on / off), **без ведущей иконки**. Она была — колокольчик в круге `secondaryContainer` 40dp, — и это была единственная иконка на строке настроек во всём приложении: nav-строки без иконок по решению владельца, зафиксированному визуальным аудитом. Она же съедала столько ширины телефона, что подпись переносилась на вторую строку.
