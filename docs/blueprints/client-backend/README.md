...
- Два исключения из этого правила осознанны и бессобытийны: жизненный цикл файловой метаданности и **разрешение личности** (`internal/store/identity.go`, фаза 030) — появление человека или устройства на проводе не видно вовсе.
