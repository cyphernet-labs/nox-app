...
**Стартовый набор (worked-пример на нейтральной модели `Item`; первая реальная поверхность NOX — список чатов, см. ниже):**
