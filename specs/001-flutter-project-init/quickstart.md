...
## 2. Setup / scaffold (указатель на блюпринт)
...
## 4. Per-platform build / launch (SC-001 / US1)
...
## 5. Theme toggle (light / dark — SC-005)
...
## 6. Structure check (готовность к фичам — SC-004 / US2)
