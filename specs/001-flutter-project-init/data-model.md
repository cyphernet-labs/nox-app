...
>
> Источник истины «как» — блюпринт `docs/blueprints/mobile/` (`00`/`03`/`04`/`05`/`11`). Бэкенд/протокол/криптоядро не выбраны — сетевые/auth/envelope/endpoint контракты помечены **пример/TBD** (ограничение конституции v1.1.0).
