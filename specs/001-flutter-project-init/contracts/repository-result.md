...
> **Источник:** блюпринт `docs/patterns/mobile/03-domain-layer.md` §1–§2; требование FR-014. Единый тип результата repo-слоя — примитив доступен в каркасе даже без реальных репозиториев фич.
