...
**Исходные данные**: описание от пользователя: "Инициализировать Flutter-проект NOX, поддерживающий все платформы, кроме web (две мобильные — Android, iOS; три десктопные — Windows, Linux, macOS). Проект должен соответствовать спецификации разработки в `docs/patterns/mobile`. Объём — только каркас (skeleton), без реальных фич."
