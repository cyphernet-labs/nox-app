...
- [ ] §1 структурная проверка — зелёная на всех 5.
- [ ] §2 compile-smoke — зелёный на всех 5 (Windows/Linux на хостах/CI).
- [ ] §3 визуал — подтверждён на macOS/iOS/Android.
- [ ] §4 `pub get` ок, генератор не запускался.
- [ ] Дефолтная иконка Flutter не отображается нигде (SC-001).
