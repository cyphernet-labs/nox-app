...
**Scale/Scope**: 37 SVG-иконок, 1 логотип (растровый плейсхолдер), 3 иллюстрации-плейсхолдера, 2 семейства шрифтов (4 файла начертаний), 9 токен-сетов, 7 ролей тайпскейла; **0 виджетов / 0 экранов**.
...
├── app_text_style_tokens.dart     # UPDATED — полная M3-шкала размеров шрифта (7 ролей), .sp, color-injecting
