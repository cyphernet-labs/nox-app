...
**Что осталось за спекой сознательно**: точная микрокопия двух новых строк интерфейса (решается при правке дизайн-спецификации, FR-023) и вопрос Q14 (ATS и App Review), который придётся закрыть до релиза, но не этой фазой.
