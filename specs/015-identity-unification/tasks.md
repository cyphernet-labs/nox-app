...
- [ ] T022 Run the gate: `make gate` (generate → format changed paths `-l 140` → analyze zero-errors → test) and `make golden-verify` (must stay at 144 — no new goldens). Then walk `quickstart.md` US1/US2/US3 manual checks.
